...
s.settimeout(timeout)
try:
     # Primanje poraka od klient start
     data = connection.recv(1024).decode()   
...
if data == 'start':
    ...
    # Poraka od klientot: Give me the hidden word
        ...
        if data=='l':
            ...
            if letter in guessed_letters:
                ...
                if letter not in random_word:
                    chances = chances-1
                # Isprakjanje na 0 ili 1 vo zavisnost dali pri pogoduvanje na bukva isto taka e pogoden zborot ili ne
